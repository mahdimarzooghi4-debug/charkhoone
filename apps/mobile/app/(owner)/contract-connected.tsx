    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.hero}>
          ...
          <OwnerBadge size="hero">مالک</OwnerBadge>
...
const styles = StyleSheet.create({
  ...
  statusValue: { color: colors.primary, fontFamily: fonts.semibold, fontSize: 14, lineHeight: 22, textAlign: "right", writingDirection: "rtl" },
  ...
  actions: { paddingHorizontal: 16, paddingVertical: 24, gap: 12 },
});
