    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.hero}>
          ...
          <OwnerBadge tone="warning">نیاز به تأیید شما</OwnerBadge>
        ...
        <View style={styles.content}>
          ...
          <AppButton onPress={() => router.replace("/(owner)/contract-active")}>تأیید نهایی قرارداد</AppButton>
          <AppButton variant="primary" onPress={() => router.back()}>بازگشت به قرارداد</AppButton>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  heroDescription: { color: "#C8D2D0", fontFamily: fonts.regular, fontSize: 14, lineHeight: 22, textAlign: "center", writingDirection: "rtl" },
  ...
  checkboxRow: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 4 },
