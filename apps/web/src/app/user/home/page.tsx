    ...
    <main className={styles.page} data-node-id="144:154" data-name="Web App / Home">
      <section className={styles.mainContent} data-node-id="144:155" data-name="Main Content">
        ...
        <section className={styles.overviewGrid} data-node-id="144:162">
          ...
          <article className={styles.overviewCard} data-node-id="144:167"><div className={styles.cardTopRow}><Badge tone="orange">پرداخت</Badge><p className={styles.cardLabel}>پرداخت بعدی</p></div><strong className={styles.accentValue}>{demoFinance.monthlyText}</strong><p className={styles.cardHint}>سررسید: ۱۵ آبان ۱۴۰۵</p></article>
        ...
        <section className={styles.membershipCard} data-node-id="184:413"><div className={styles.membershipTitle}><Badge>فعال</Badge><strong>عضویت چارخونه</strong></div><div className={styles.membershipInfo}><span className={styles.verticalDivider} /><span className={styles.infoPair}><span>سقف تأمین مالی</span><strong>تا ۵۰۰٬۰۰۰٬۰۰۰ تومان</strong></span><span className={`${styles.infoPair} ${styles.remainingInfo}`}><span>دفعات باقی‌مانده</span><strong>۱ بار</strong></span></div></section>
