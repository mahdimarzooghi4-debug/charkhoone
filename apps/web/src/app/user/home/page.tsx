  ...
  return (
    <main className={styles.page} data-node-id="144:154" data-name="Web App / Home">
      <section className={styles.mainContent} data-node-id="144:155" data-name="Main Content">
        ...
        <section className={styles.financialSection} data-node-id="144:252"><div className={styles.sectionHeader}><Link href="/user/receive-pay">مشاهده همه</Link><h2>دریافت و پرداخت</h2></div><div className={styles.activityTable}><div className={styles.tableHeader}><span>وضعیت</span><span>تاریخ</span><span>مبلغ</span><span>قرارداد</span><span>نوع</span></div><div className={styles.tableRow}><span><Badge tone="orange">در انتظار پرداخت</Badge></span><span className={styles.muted}>۱۵ آبان ۱۴۰۵</span><strong>۶٬۷۰۸٬۳۳۳ تومان</strong><span>سعادت‌آباد</span><span><Badge tone="red">پرداخت</Badge></span></div><div className={styles.tableRow}><span><Badge tone="gray">آینده</Badge></span><span className={styles.muted}>۱ آذر ۱۴۰۵</span><strong>۱۵٬۰۰۰٬۰۰۰ تومان</strong><span>پونک</span><span><Badge>دریافت</Badge></span></div></div></section>
      </section>
