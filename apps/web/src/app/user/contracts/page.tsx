...
export default function ContractsPage() {
  return (
    <main className={styles.page} data-node-id="149:150" data-name="Web App / Contracts">
      ...
      <aside className={styles.sidebar} data-node-id="142:1983"><div className={styles.sidebarTop} data-node-id="142:1984"><div className={styles.logoWrap} data-node-id="142:1985"><img src={assets.logo} alt="چارخونه" width={127} height={55} /></div><nav className={styles.nav} data-node-id="142:1986" aria-label="ناوبری حساب کاربری"><Link href="/user/home" className={styles.navItem} data-node-id="142:1987"><span className={styles.navSpacer} /><span>خانه</span><img src={assets.home} alt="" width={20} height={20} /></Link><Link href="/user/contracts" className={`${styles.navItem} ${styles.navActive}`} data-node-id="142:1993"><span className={styles.alertBadge}>۱</span><span>قراردادها</span><img src={assets.contracts} alt="" width={20} height={20} /></Link><Link href="/user/receive-pay" className={styles.navItem} data-node-id="142:2000"><span className={styles.navSpacer} /><span>دریافت و پرداخت</span><img src={assets.payments} alt="" width={20} height={20} /></Link><Link href="/user/account" className={styles.navItem} data-node-id="142:2006"><span className={styles.navSpacer} /><span>حساب من</span><img src={assets.account} alt="" width={20} height={20} /></Link></nav></div><div className={styles.profile} data-node-id="142:2012"><img className={styles.avatar} src={assets.avatar} alt="" width={40} height={40} /><div className={styles.profileText} data-node-id="142:2014"><strong data-node-id="142:2015">علی رضایی</strong><span data-node-id="142:2016">۰۹۱۲•••••۶۷</span></div></div></aside>
    </main>
  );
}
