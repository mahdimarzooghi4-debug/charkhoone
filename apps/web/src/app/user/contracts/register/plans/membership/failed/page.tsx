      ...
      <section className={styles.mainContent} data-node-id="175:857">
        ...
        <div className={styles.resultWrapper} data-node-id="175:870">
          <section className={styles.resultCard} data-node-id="175:871">
            ...
            <div className={styles.statusSection} data-node-id="175:875"><span className={styles.failedCircle} data-node-id="175:876"><img src={assets.check} alt="" width={24} height={24} /></span><h2 data-node-id="175:880">سناریوی نمونه: پرداخت حق عضویت ناموفق بود</h2><strong className={styles.amount} data-node-id="175:881">۲٬۵۰۰٬۰۰۰ تومان</strong><span className={styles.failedBadge} data-node-id="175:883">ناموفق</span></div>
          ...
          <div className={styles.actions} data-node-id="175:927"><Link href="/user/contracts/register/plans/membership" className={styles.secondaryAction} data-node-id="175:928">بازگشت به انتخاب عضویت</Link><Link href="/user/contracts/register/plans/membership/result" className={styles.primaryAction} data-node-id="175:930">بازگشت به انتخاب عضویت (نمونه)</Link></div>
        </div>
      </section>
