      ...
      <section className={styles.mainContent} data-node-id="161:164">
        ...
        <div className={styles.columns} data-node-id="161:179">
          <aside className={styles.secondaryColumn} data-node-id="161:180">
            ...
            <section className={styles.card} data-node-id="161:200"><h2 data-node-id="161:201">وضعیت تسویه</h2><div className={styles.divider} /><div className={styles.settlementRows}><div><strong>انجام شده</strong><span>آخرین تسویه</span></div><div><strong>۱۵ مهر ۱۴۰۵</strong><span>تاریخ آخرین تسویه</span></div><div><strong className={styles.accent}>۱۵ آبان ۱۴۰۵</strong><span>{fund ? "تجمیع بعدی (نمونه)" : "تسویه بعدی"}</span></div></div><div className={styles.divider} /><Link href="/user/receive-pay" className={styles.smallButton} data-node-id="161:215">مشاهده سوابق</Link></section>

            <section className={styles.card} data-node-id="161:217"><h2 data-node-id="161:218">دسترسی سریع</h2><div className={styles.divider} /><div className={styles.quickActions}><Link href="/user/receive-pay">‹ <span>مشاهده دریافت و پرداخت</span></Link><a href="#owner-property-info">‹ <span>مشاهده اطلاعات ملک</span></a></div></section>
          </aside>
