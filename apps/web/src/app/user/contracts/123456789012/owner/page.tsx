...
const conditions = [
  ...
  ["رهن کامل معادل (نمونه)", "۱٬۱۶۶٬۶۶۶٬۶۶۷ تومان"],
      ...
      <section className={styles.mainContent} data-node-id="161:164">
        ...
        <div className={styles.columns} data-node-id="161:179">
          ...
          <div className={styles.primaryColumn} data-node-id="161:227">
            <section className={styles.activeStatus} data-node-id="161:228"><div className={styles.activeTop}><span className={styles.currentBadge}>قرارداد جاری</span><h2 data-node-id="161:233">قرارداد فعال است</h2></div><div className={styles.divider} /><p data-node-id="161:235">در این سناریوی نمایشی، قرارداد فعال نشان داده می‌شود؛ تأیید و تسویه واقعی بانک انجام نشده است.</p><strong data-node-id="161:236">فعال از ۱۵ مهر ۱۴۰۵</strong></section>

            <section className={styles.card} data-node-id="161:237"><div className={styles.cardHeader}><span className={styles.waitBadge}>در انتظار تسویه</span><h2 data-node-id="161:241">{fund ? "تجمیع بعدی" : "دریافتی بعدی"}</h2></div><div className={styles.divider} /><div className={styles.nextSettlement} data-node-id="161:243"><div><span data-node-id="161:245">تاریخ سررسید</span><strong data-node-id="161:246">۱۵ آبان ۱۴۰۵</strong></div><div><span data-node-id="161:248">{fund ? "مبلغ خالص قابل تجمیع" : "مبلغ خالص قابل تسویه"}</span><strong className={styles.bigAmount} data-node-id="161:249">۳۴٬۸۲۵٬۰۰۰ تومان</strong></div></div><p className={styles.infoBox} data-node-id="161:251">{fund ? "این صفحه نمونه است؛ مبلغ خالص ۳۴٬۸۲۵٬۰۰۰ تومان بر پایه رهن کامل معادل قرارداد محاسبه شده و مطابق مدل انتخاب‌شده در صندوق تجمیع می‌شود. تسویهٔ بانکی واقعی انجام نشده است." : "این دریافتی نمونه بر پایه رهن کامل معادل ۱٬۱۶۶٬۶۶۶٬۶۶۷ تومان است: معادل ماهانه ۳٪ برابر ۳۵٬۰۰۰٬۰۰۰ تومان و پس از کارمزد نمونه ۰٫۵٪، مبلغ خالص ۳۴٬۸۲۵٬۰۰۰ تومان می‌شود. این مبلغ با سود وام ماهانه مستأجر متفاوت است و واریز واقعی یا تضمینی انجام نشده است."}</p><Link href={`/user/receive-pay?method=${fund ? "fund" : "monthly"}`} className={styles.smallButton} data-node-id="161:253">مشاهده در دریافت و پرداخت</Link></section>
            ...
            <section className={styles.card} data-node-id="161:283"><div className={styles.cardHeader}><span className={styles.completeBadge}>تکمیل شده</span><h2 data-node-id="161:287">وضعیت تأمین مالی</h2></div><div className={styles.divider} /><div className={styles.financingGrid} data-node-id="161:289"><div><strong data-node-id="161:291">۳۵۰٬۰۰۰٬۰۰۰ تومان</strong><span data-node-id="161:292">مبلغ تأمین‌شده</span></div><div><strong data-node-id="161:294">بانک نمونه</strong><span data-node-id="161:295">بانک ارائه دهنده</span></div></div><p className={styles.successInfo} data-node-id="161:297">مبلغ نمونه برای رتبه C3 با سهم ۳۰٪ از رهن کامل معادل است؛ اصل وام و زمان تسویه آن طبق قرارداد نهایی بانک تعیین می‌شود.</p></section>
          </div>
        </div>
      </section>
