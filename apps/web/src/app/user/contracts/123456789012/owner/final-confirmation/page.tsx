      ...
      <section className={styles.mainContent} data-node-id="150:1831">
        ...
        <div className={styles.columns} data-node-id="150:1847">
          ...
          <div className={styles.mainColumn} data-node-id="150:1902">
            ...
            <section className={styles.card} data-node-id="150:1936"><div className={styles.cardHeader}><h2 data-node-id="150:1940">تأمین مالی قرارداد</h2><span className={styles.badgeSuccess}>تأیید شده</span></div><div className={styles.divider} /><div className={`${styles.summaryGrid} ${styles.two}`}><div><strong>بانک نمونه</strong><span>بانک ارائه دهنده</span></div><div><strong>۳۵۰٬۰۰۰٬۰۰۰ تومان</strong><span>مبلغ تأمین‌شده</span></div></div><div className={styles.notice} data-node-id="150:1949">این مبلغ صرفاً نمونه رتبه C3 است و تأیید/واریز واقعی بانک انجام نشده؛ زمان تسویه اصل وام طبق قرارداد نهایی بانک تعیین خواهد شد.</div></section>

            <section className={`${styles.card} ${styles.selectedPayout}`} data-node-id="150:1952"><div className={styles.selectedPayoutHeader}><strong data-node-id="150:1956">روش دریافت انتخاب‌شده: {isMonthly ? "دریافت ماهانه" : "تجمیع دریافتی در صندوق"}</strong><Link href="/user/contracts/123456789012/owner/settlement-preference" data-node-id="150:1953">تغییر روش دریافت</Link></div><p data-node-id="150:1959">{isMonthly ? "این برآورد دریافتی مالک بر پایه رهن کامل معادل قرارداد و نسبت ۳٪ است؛ با پرداخت سود وام مستأجر یکی نیست و هیچ واریز واقعی انجام نمی‌شود." : "این برآورد مستقلِ دریافتی مالک بر پایه رهن کامل معادل قرارداد و نسبت ۳٪ است؛ صندوق و بازده واقعی فعال نیست و این مبلغ از سود وام مستأجر محاسبه نشده است."}</p><div className={styles.divider} /><div className={styles.rowList}><div className={styles.row}><span>مبلغ ناخالص دریافتی:</span><strong>۳۵٬۰۰۰٬۰۰۰ تومان</strong></div><div className={styles.row}><span>کارمزد خدمات چارخونه - ۰٫۵٪:</span><strong>−۱۷۵٬۰۰۰ تومان</strong></div><div className={styles.row}><span>{isMonthly ? "مبلغ خالص قابل تسویه:" : "مبلغ خالص قابل تجمیع:"}</span><strong className={styles.moneyGreen}>۳۴٬۸۲۵٬۰۰۰ تومان</strong></div>{!isMonthly && <div className={styles.row}><span>بازده</span><strong>براساس شرایط صندوق</strong></div>}</div></section>
