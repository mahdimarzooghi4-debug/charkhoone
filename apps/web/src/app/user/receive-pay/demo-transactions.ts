...
export const previews: Record<PreviewTransaction, Preview> = {
  overdue: { amount: "۱۸٬۵۰۰٬۰۰۰ تومان", date: "۱۵ شهریور ۱۴۰۵", time: "۱۴:۳۵", reference: "نمونه ۱۲۳۴۵۶۷۸۹", description: "قسط معوق تأمین مالی — ماه ۱ از ۳", contract: "سعادت‌آباد", role: "مستأجر", kind: "پرداخت", installment: "۱ از ۱۲" },
  due: { amount: "۱۸٬۵۰۰٬۰۰۰ تومان", date: "۱۵ آبان ۱۴۰۵", time: "۱۴:۳۵", reference: "نمونه ۱۲۳۴۵۶۷۸۹", description: "قسط ماهانه تأمین مالی", contract: "سعادت‌آباد", role: "مستأجر", kind: "پرداخت", installment: "۲ از ۱۲" },
  "paid-mehr": { amount: "۱۸٬۵۰۰٬۰۰۰ تومان", date: "۱۵ مهر ۱۴۰۵", time: "۱۴:۳۵", reference: "نمونه ۱۲۳۴۵۶۷۸۹", description: "قسط مهر ۱۴۰۵", contract: "سعادت‌آباد", role: "مستأجر", kind: "پرداخت", installment: "۱ از ۱۲" },
...
export const activities: readonly Activity[] = [
  { nodeId: "150:482", kind: "پرداخت", kindTone: "payment", contract: "سعادت‌آباد", role: "مستأجر", description: "قسط معوق تأمین مالی — ماه ۱ از ۳", amount: "۱۸٬۵۰۰٬۰۰۰ تومان", date: "۱۵ شهریور ۱۴۰۵", status: "معوق", statusTone: "overdue", action: "پرداخت (نمونه)", primaryAction: true, href: "/user/receive-pay/result?transaction=overdue" },
  { nodeId: "150:498", kind: "پرداخت", kindTone: "payment", contract: "سعادت‌آباد", role: "مستأجر", description: "قسط ماهانه تأمین مالی", amount: "۱۸٬۵۰۰٬۰۰۰ تومان", date: "۱۵ آبان ۱۴۰۵", status: "در انتظار پرداخت", statusTone: "waiting", action: "پرداخت (نمونه)", primaryAction: true, href: "/user/receive-pay/result?transaction=due" },
  ...
  { nodeId: "150:530", kind: "پرداخت", kindTone: "payment", contract: "سعادت‌آباد", role: "مستأجر", description: "قسط مهر ۱۴۰۵", amount: "۱۸٬۵۰۰٬۰۰۰ تومان", date: "۱۵ مهر ۱۴۰۵", status: "پرداخت شده", statusTone: "success", action: "مشاهده رسید", href: "/user/receive-pay/receipt?transaction=paid-mehr" },
