...
export const previews: Record<PreviewTransaction, Preview> = {
  overdue: { amount: "۶٬۷۰۸٬۳۳۳ تومان", date: "۱۵ شهریور ۱۴۰۵", time: "۱۴:۳۵", reference: "نمونه ۱۲۳۴۵۶۷۸۹", description: "سود معوق نمونه وام — ماه ۱ از ۳", contract: "سعادت‌آباد", role: "مستأجر", kind: "پرداخت", installment: "نمونه" },
...
export const activities: readonly Activity[] = [
  { nodeId: "150:482", kind: "پرداخت", kindTone: "payment", contract: "سعادت‌آباد", role: "مستأجر", description: "سود معوق نمونه وام — ماه ۱ از ۳", amount: "۶٬۷۰۸٬۳۳۳ تومان", date: "۱۵ شهریور ۱۴۰۵", status: "معوق", statusTone: "overdue", action: "پرداخت (نمونه)", primaryAction: true, href: "/user/receive-pay/result?transaction=overdue" },
