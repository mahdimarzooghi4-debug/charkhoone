      ...
      <section className={styles.mainContent}>
        ...
        <div className={styles.columns}>
          <aside className={styles.secondaryColumn}>
            <section className={styles.settingsCard}><h2>تنظیمات</h2><div className={styles.settingsList}><div className={styles.settingsRow}><span className={styles.toggle}><i /></span><span>اعلان‌ها</span></div><div className={styles.divider} /><a className={styles.settingsRow} href="/terms"><img src={assets.chevron} alt="" width={20} height={20} /><span>قوانین و مقررات</span></a><div className={styles.divider} /><a className={styles.settingsRow} href="/privacy"><img src={assets.chevron} alt="" width={20} height={20} /><span>حریم خصوصی</span></a></div></section>
          </aside>
