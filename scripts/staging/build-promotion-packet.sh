...
require_line "$application_summary" 'worker_http_readiness=passed'
...
require_line "$application_statuses" 'worker_health_ready=200'
...

{
  ...
  printf 'worker_http_readiness=validated\n'
